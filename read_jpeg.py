# -*- coding: utf-8 -*-
"""
Created on Wed Apr 30 23:04:24 2014
...
"""
We use this file to convert our jpg into a vector
"""
import sys
from math import *
from Tkinter import *
...
def calc_add_bits(len, val):
   """ Calculate the value from the "additional" bits in the
       huffman data. """
   if (val & (1 << len-1)):
      pass
   else:
...
def restore_dc(data):
   """ Restore the DC values as the DC values are coded as the 
       difference from the previous DC value of the same component """
...
def for_each_du_in_mcu(mcu, func):
   """ Helper function that iterates over all DU's in an 
       MCU and runs "func" on it """
